...
<p align="center">
  <img width="700" src="assets/image/preview.gif">
</p>
...
<p align="center">
  <img width="300" src="assets/image/image_nrT0DENA5M.png">
</p>
...
左图对应 **L2正则化**，右图对应 **L1正则化**。从函数叠加的视角看，L2正则化像一个光滑的引力场，将解均匀地拉向原点，实现 **参数收缩**；而L1正则化则像一个带有特定路径（坐标轴上的"山谷"）的引力场，倾向于将解"拽"到坐标轴上，从而实现 **稀疏化和特征选择**。
...
<p align="center">
  <img width="600" src="assets/image/image_--petPNsWO.png">
</p>
...
<p align="center">
  <img width="600" src="assets/image/image_OCcha6b4-E.png">
</p>
